...
fetch('http://127.0.0.1:5002/api/recommendation?id=3&type=0', myInit)
.then(response => response.json())
.then(suggestions => {
    suggestions.forEach(suggestion => {
        console.log(suggestion)
        $('#add-info').append(`<div class="result" id="result${suggestion.id}">
								<div class="head">
									<div class="covers">
								...
								<div class="infos">
									...
									<div>
										...
										<ul>
											...
											<li><img src="assets/img/profile_ico_age.png" alt="">  <span>${suggestion.age}</span></li>
								...
								<div class="interaction">
									...
									<div class="primary letsRock" data-id="${suggestion.id}"><img src="assets/img/card_ico_rock.png" alt=""></div>
									<div class="secondary letsReject"  data-id="${suggestion.id}"><img src="assets/img/card_ico_close.png" alt=""></div>
								</div>
							</div>
        `);    
    });
